...
public class Servidor implements Runnable {
    ...
    private void realizarBackup() {
        String sshCommand = "ssh administrador@4.212.9.198 \"mysqldump -u root --password=1234 --databases simarropop > /home/administrador/backup.sql\"";
        ...
        String backupLocalPath = "C:\\Users\\crazy\\Desktop\\ProyectoFinal\\AccesoADatos\\PSP_GrupoE\\PSP_GrupoE\\src\\main\\resources\\backup\\backup.sql";
        String scpCommand = "scp administrador@4.212.9.198:/home/administrador/backup.sql " + backupLocalPath.replace("\\", "/");
    ...
    public void enviarCorreo() {
        ...
        String correo = "ssh -T administrador@4.212.9.198 \"echo 'Se ha realizado el backup sin fallos.' | mail -s 'Backup Realizado con Éxito' " + correoEscrito + "\"";
